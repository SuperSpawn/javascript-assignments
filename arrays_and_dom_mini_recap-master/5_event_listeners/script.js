...
document.querySelector('.box').addEventListener('click', clickFirstBox);

function clickFirstBox(e) {
...
document.querySelector('#container').addEventListener('click', clickContainer);
...
document.querySelector('.box').removeEventListener('click');
